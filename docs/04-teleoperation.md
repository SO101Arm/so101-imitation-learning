...
lerobot-teleoperate \
    ...
    --robot.cameras="{front: {type: opencv, index_or_path: 0, width: 640, height: 480, fps: 30}, {up: {type: opencv, index_or_path: 2, width: 640, height: 480, fps: 30}}" \ # <- paste here the camera information found at previous step
